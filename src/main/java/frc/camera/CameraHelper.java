...
public class CameraHelper
{
    ...
    private final BooleanSupplier camera_override;
     ...
     *  @param camera_override Force use of camera, ignore odometry?
    ...
    public CameraHelper(AprilTagFieldLayout tags,
                        BooleanSupplier camera_override,
                        String camera_name,
    ...
    {
        this.tags = tags;
        this.camera_override = camera_override;
        ...
        for (PhotonPipelineResult result : camera.getAllUnreadResults())
            if (result.hasTargets())
                for (PhotonTrackedTarget target : result.getTargets())
                {
                    ...
                    // Ignore odometry, override with camera reading?
                    if (camera_override.getAsBoolean())
